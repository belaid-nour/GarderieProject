  ...
  implements OnInit
{
  ...
  ngOnInit() {
    if (this.authService.currentUserValue) {
      ...
      // Utilisation de 'nom' et 'prenom' dans le userFullName
      this.userFullName =
        this.authService.currentUserValue.nom + ' ' + this.authService.currentUserValue.prenom;
      ...
      // Affectation du type d'utilisateur selon le rôle
